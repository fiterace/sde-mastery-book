# SDE Mastery Book — Complete Edition

> *Generated by merge.sh on 2026-05-20 17:50*
> *Edit individual chapter files in `parts/`, then re-run merge.sh*

---

# Part 1 — CS & Systems Foundations

> *Part introduction written by assembly-agent after all chapters complete.*

DSA excluded — assumed known. These are the foundations that senior engineers actually use to reason about why systems behave the way they do. Code examples: Python (primary) + Go (secondary).

---

## Chapters

- [Chapter 1: OS fundamentals for engineers](ch_1.md)
- [Chapter 2: Networking in depth](ch_2.md)
- [Chapter 3: Concurrency & parallelism](ch_3.md)
- [Chapter 4: Database internals — relational](ch_4.md)
- [Chapter 5: Database internals — non-relational](ch_5.md)
- [Chapter 6: Storage & I/O](ch_6.md)
- [Chapter 7: Distributed systems foundations](ch_7.md)
- [Chapter 8: Consensus & replication](ch_8.md)
...
# Part 2 — Low-Level Design & Clean Code

> *Part introduction written by assembly-agent after all chapters complete.*

The answer to: "I know what to build. How do I build it well, and how do I change it later without breaking everything?" Code examples: Python + TypeScript. Every pattern includes a "when NOT to use this" section.

---

## Chapters

- [Chapter 9: Clean code principles](ch_9.md)
- [Chapter 10: Design patterns in practice](ch_10.md)
- [Chapter 11: Low-level design (LLD)](ch_11.md)
- [Chapter 12: API design](ch_12.md)
- [Chapter 13: Testing strategy](ch_13.md)
- [Chapter 14: Logging, metrics & tracing](ch_14.md)
- [Chapter 15: Security for application developers](ch_15.md)
- [Chapter 16: Code review & refactoring](ch_16.md)
- [Chapter 17: Performance engineering](ch_17.md)
...
Every chapter: concept → real scale numbers → design patterns → trade-offs → 2+ real incidents → a full design walkthrough. Grounded in AWS where a managed option exists.

---

## Chapters

- [Chapter 18: Scalability fundamentals](ch_18.md)
- [Chapter 19: Caching architecture](ch_19.md)
- [Chapter 20: Database scaling patterns](ch_20.md)
- [Chapter 21: Message queues & event streaming](ch_21.md)
- [Chapter 22: Microservices & service decomposition](ch_22.md)
- [Chapter 23: API gateways, rate limiting & resilience](ch_23.md)
- [Chapter 24: Search architecture](ch_24.md)
- [Chapter 25: Distributed systems in practice](ch_25.md)
- [Chapter 26: Observability at scale](ch_26.md)
- [Chapter 27: Classic system design problems](ch_27.md)

---

# Part 4 — Real-World Problem Scenarios

> *Part introduction written by assembly-agent after all chapters complete.*

**This is the imposter syndrome cure.** Organized by symptom — when you hit a problem at 2am you don't think "I need the Kafka chapter." You think "jobs aren't running." This part meets you where you are.

---

## Chapters

- [Chapter 28: My service is slow](ch_28.md)
- [Chapter 29: My service is down](ch_29.md)
- [Chapter 30: Data is inconsistent](ch_30.md)
- [Chapter 31: My queue / async job is broken](ch_31.md)
- [Chapter 32: My deployment broke production](ch_32.md)
- [Chapter 33: My API is being abused or is unreliable](ch_33.md)
- [Chapter 34: My costs are exploding](ch_34.md)
- [Chapter 35: I need to scale this feature fast](ch_35.md)
- [Chapter 36: My data pipeline / ETL is broken](ch_36.md)
- [Chapter 37: Auth / permissions are broken](ch_37.md)
- [Chapter 38: I need to migrate this legacy system](ch_38.md)
- [Chapter 39: My search is returning bad results](ch_39.md)
- [Chapter 40: My cache is causing more problems than it solves](ch_40.md)
- [Chapter 41: Memory leak / OOM in production](ch_41.md)
- [Chapter 42: Concurrency bug in application code](ch_42.md)
- [Chapter 43: My tests are slow / unreliable / flaky](ch_43.md)
- [Chapter 44: My build / CI pipeline is broken or slow](ch_44.md)
- [Chapter 45: It works locally but not in production](ch_45.md)
- [Chapter 46: Performance regression between releases](ch_46.md)
- [Chapter 47: Third-party integration is broken](ch_47.md)
- [Chapter 48: I can't reproduce this bug locally](ch_48.md)
- [Chapter 49: My observability is blind](ch_49.md)
- [Chapter 50: I need to handle a traffic spike I didn't plan for](ch_50.md)
- [Chapter 51: I need to coordinate a change across multiple teams](ch_51.md)
- [Chapter 52: I inherited a system with no documentation](ch_52.md)
- [Chapter 53: I need to onboard someone onto a system I own](ch_53.md)
- [Chapter 54: Schema change needed but can't take downtime](ch_54.md)
- [Chapter 55: I shipped a bug and need to fix it without making it worse](ch_55.md)

---

# Part 5 — Tech Stack Deep Dives

> *Part introduction written by assembly-agent after all chapters complete.*

Each chapter: core internals → local setup → production patterns → common pitfalls → real-world usage examples from the corpus → mini project. MongoDB, Elasticsearch, and GraphQL are full working-depth chapters.

---

## Your existing stack — closing the gaps

- [Chapter 56: Python + FastAPI deep](ch_56.md)
- [Chapter 57: Node.js + TypeScript deep](ch_57.md)
- [Chapter 58: React + Next.js](ch_58.md)
- [Chapter 59: AWS in depth](ch_59.md)

## New stack — full production depth

- [Chapter 60: Docker](ch_60.md)
- [Chapter 61: Kubernetes](ch_61.md)
- [Chapter 62: Kafka](ch_62.md)
- [Chapter 63: PostgreSQL deep dive](ch_63.md)
- [Chapter 64: Redis deep dive](ch_64.md)
- [Chapter 65: Terraform](ch_65.md)
- [Chapter 66: Go](ch_66.md)
- [Chapter 67: gRPC](ch_67.md)

## Working production depth

- [Chapter 68: MongoDB](ch_68.md)
- [Chapter 69: Elasticsearch / OpenSearch](ch_69.md)
- [Chapter 70: GraphQL](ch_70.md)

---

# Part 6 — Guided Projects

> *Part introduction written by assembly-agent after all chapters complete.*

24 fully buildable projects across 3 tiers. Each project includes: architecture diagram, full DDL, docker-compose.yml, .env.example, step-by-step build guide, testing checklist, deployment section, and "what an interviewer would ask about your design choices."

**Note:** This Part requires Parts 1–5 to be complete — it cross-references them extensively.

---

## Tier 1 — SDE 2 (10 projects)

- [P01: URL shortener with analytics](p01.md)
- [P02: JWT auth service with RBAC](p02.md)
- [P03: Task management API + background jobs](p03.md)
- [P04: Real-time chat app](p04.md)
- [P05: E-commerce product catalog](p05.md)
- [P06: Personal finance tracker](p06.md)
- [P07: Blog platform with CMS](p07.md)
- [P08: Rate limiter library + middleware](p08.md)
- [P09: CLI DevTools suite](p09.md)
- [P10: REST API scaffolding generator](p10.md)

## Tier 2 — SDE 2+ / Senior (8 projects)

- [P11: Distributed job scheduler](p11.md)
- [P12: Event-driven order processing](p12.md)
- [P13: Multi-tenant SaaS API](p13.md)
- [P14: Multi-channel notification service](p14.md)
- [P15: Observability platform](p15.md)
- [P16: API gateway from scratch](p16.md)
- [P17: GraphQL federation layer](p17.md)
- [P18: Search + recommendation service](p18.md)

## Tier 3 — Staff+ / Principal (6 projects)

- [P19: Distributed key-value store](p19.md)
- [P20: Feature flag platform](p20.md)
- [P21: ML model serving platform](p21.md)
- [P22: Realtime collaborative editor](p22.md)
- [P23: Kubernetes operator](p23.md)
- [P24: Open-source CLI framework](p24.md)

---

# Part 7 — Professional Engineering

> *Part introduction written by assembly-agent after all chapters complete.*

The craft beyond the code. Incident response, technical leadership, communication, career navigation — the skills that separate senior engineers from staff engineers.

---

## Chapters

- [Chapter 71: Incident response & postmortems](ch_71.md)
- [Chapter 72: Technical leadership without management](ch_72.md)
- [Chapter 73: Effort estimation & project planning](ch_73.md)
- [Chapter 74: Engineering communication](ch_74.md)
- [Chapter 75: Career navigation](ch_75.md)
- [Chapter 76: Staying current without burning out](ch_76.md)
